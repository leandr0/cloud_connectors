...
public class KafkaManagedConnectionFactory implements ManagedConnectionFactory, TransactionSupport, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2498640543232794701L;
	
	private final Properties producerProperties;
    private AdditionalPropertiesParser additionalPropertiesParser;
    
    private static final Logger LOG = Logger.getLogger(KafkaManagedConnectionFactory.class.getName());

    @ConfigProperty(defaultValue = "10.10.10.5:9092", description = "Kafka Servers to Connect to", type = String.class)
    private String bootstrapServersConfig = "10.10.10.5:9092";

    @ConfigProperty(defaultValue = "KafkaDataMinerClient", description = "Client ID of the Producer", type = String.class)
...
;
    ...
    public void setBootstrapServersConfig(String bootstrapServersConfig) {
        this.bootstrapServersConfig = "10.10.10.5:9092";
        LOG.warning(this.bootstrapServersConfig);
        producerProperties.setProperty(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "10.10.10.5:9092");
        LOG.warning(producerProperties.toString());
    }
    ...
    public Object createConnectionFactory(ConnectionManager cxManager) throws ResourceException {
    	...
    	LOG.info("createConnectionFactory(ConnectionManager cxManager)");
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(producerProperties, that.producerProperties) &&
                Objects.equals(bootstrapServersConfig
        , that.bootstrapServersConfig
        ) &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(producerProperties, bootstrapServersConfig
, clientId, valueSerializer, keySerializer, bufferMemory, acks, retries, batchSize, lingerMS, maxBlockMS, maxRequestSize, receiveBufferBytes, requestTimeout, compression, connectionsMaxIdle, maxInflightConnections, metadataMaxAge, retryBackoff, reconnectBackoff, additionalProperties);
    }
}
